...
public class MuteVideoOperation : IVideoOperation
{
    private readonly IFFmpegService _ffmpeg;

    public MuteVideoOperation(IFFmpegService ffmpeg)
    {
        _ffmpeg = ffmpeg;
    }

    public string DisplayName => "Mute Video";
        ...
        CancellationToken ct = default)
    {
        ...
        var args = $"-i \"{input}\" -an -c copy -map 0 -y \"{outputPath}\"";
